echo "Cʀᴇᴀᴛᴇᴅ Bʏ FUZEDMODS"
echo "ᴛᴇʟᴇɢʀᴀᴍ: @ғᴜᴢᴇᴅᴍᴏᴅs"
sleep 2
echo "★彡 🄻🄾🄶 🄱🄻🄾🄲🄺🄴🅁 彡★"
echo " ᖇᝪᝪᎢ&ᑎᝪ ᖇᝪᝪᎢ "
sleep 1
...
rm -rf /sdcard/Android/data/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/apollo_reslist.flist
